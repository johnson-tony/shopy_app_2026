            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div id="foodRestaurantField" class="{{ $product->mode?->slug === 'food' ? '' : 'hidden' }} sm:col-span-2 space-y-4 pt-3 border-t border-slate-800">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="restaurant_id" name="restaurant_id"
                                        ...
                                        @foreach ($restaurants ?? [] as $rest)
                                            <option value="{{ $rest->id }}" {{ old('restaurant_id', $product->restaurant_id) == $rest->id ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-2 mt-1">
                                        <label class="flex items-center gap-2 p-2.5 rounded-xl bg-slate-950 border border-slate-800 cursor-pointer hover:border-emerald-500 transition">
                                            <input type="radio" name="is_veg" value="1" {{ old('is_veg', $product->is_veg) === true || old('is_veg', $product->is_veg) === 1 || old('is_veg', $product->is_veg) === '1' ? 'checked' : '' }} class="text-emerald-500 focus:ring-emerald-500">
                                        ...
                                        <label class="flex items-center gap-2 p-2.5 rounded-xl bg-slate-950 border border-slate-800 cursor-pointer hover:border-rose-500 transition">
                                            <input type="radio" name="is_veg" value="0" {{ old('is_veg', $product->is_veg) === false || old('is_veg', $product->is_veg) === 0 || old('is_veg', $product->is_veg) === '0' ? 'checked' : '' }} class="text-rose-500 focus:ring-rose-500">
