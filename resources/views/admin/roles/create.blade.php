...
@section('title', 'Create New Role — Shopy Admin')
...
<div class="space-y-6 max-w-6xl mx-auto">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl sm:text-3xl font-bold text-white tracking-tight">Create Administrator Role</h1>
            <p class="text-slate-400 text-sm mt-1">Define permissions and shopping modes for staff accounts.</p>
        </div>
    </div>
        ...
        <div class="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="e.g. Food Manager" required
                ...
                <div>
                    <label for="slug" class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">
                        Role Slug <span class="text-slate-500 text-[11px] font-normal">(Auto-generated if empty)</span>
                    </label>
                    <input type="text" name="slug" id="slug" value="{{ old('slug') }}" placeholder="e.g. food-manager"
                        class="w-full bg-slate-950 border border-slate-800 focus:border-indigo-500 rounded-xl px-4 py-2.5 text-white text-sm font-mono placeholder-slate-500 focus:outline-none transition-all">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="2" placeholder="Briefly describe what duties this role encompasses..."
                        class="w-full bg-slate-950 border border-slate-800 focus:border-indigo-500 rounded-xl px-4 py-2.5 text-white text-sm placeholder-slate-500 focus:outline-none transition-all">{{ old('description') }}</textarea>
                </div>
